...
public class SimpleChunkHandler implements ChunkHandler {

    private final StructureManager manager;
    private final StructureFactory factory;

    public SimpleChunkHandler(StructureManager manager, StructureFactory factory) {
    ...
    public ChunkHolder deserialize(NamespacedKey toDeserialize) {
        ...
        return new SimpleChunkHolder(structure);
    }
